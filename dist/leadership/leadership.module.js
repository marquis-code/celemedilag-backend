...
exports.LeadershipModule = LeadershipModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: leader_schema_1.Leader.name, schema: leader_schema_1.LeaderSchema }]),
            upload_module_1.UploadModule
        ],
        controllers: [leadership_controller_1.LeadershipController],
